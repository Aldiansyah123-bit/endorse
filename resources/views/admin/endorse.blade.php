        ...
        <div class="modal-content">
            ...
            <form action="{{ route('endorse.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" name="company" placeholder="Nama Perusahaan" class="form-control">
                    </div>

                    <label>Alamat Perusahaan: </label>
                    <div class="form-group">
                        <input type="text" name="address_company" placeholder="Alamat Perusahaan" class="form-control">
                    </div>

                    <label>Umur: </label>
                    <div class="form-group">
                        <input type="number" name="age" placeholder="Umur" class="form-control">
                    </div>
                    ...
                    <label>Informasi Pengalaman: </label>
                    <div class="form-group">
                        <textarea type="text" name="description" placeholder="Deskripsi" class="form-control" rows="3"></textarea>
                    </div>
                </div>
